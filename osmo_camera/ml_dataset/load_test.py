...
class TestLoadMultiExperimentDatasetCsv:
    def test_calls_get_local_filepaths_with_appropriate_info_and_returns_dataframe(self, tmp_path, mocker):
        ...
        actual_returned_dataframe = module.load_multi_experiment_dataset_csv(csv_filepath)
